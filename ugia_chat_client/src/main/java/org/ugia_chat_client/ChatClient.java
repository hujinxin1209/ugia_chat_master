...
import com.ugia.common.util.DateTimeUtil;
import com.ugia.common.util.FileUtil;
...
public class ChatClient extends Frame {
    ...
    private void initNetWork() {
        try {
            selector = Selector.open();//103.79.76.244
            clientChannel = SocketChannel.open(new InetSocketAddress("103.79.76.244", 9000));
            //设置客户端为非阻塞模式
